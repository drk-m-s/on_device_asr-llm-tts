...
# Import parent class
from llm_tts_jingzhi import LLMTTSStreamer

from opencc import OpenCC
# Create a converter: Traditional -> Simplified
cc = OpenCC('t2s')
...
class VoiceConversationSystem(LLMTTSStreamer):
    ...
    def start_voice_conversation(self):
        ...
        welcome_msg = ("您好，我们这儿是APS系统，有什么想问我的呢？")            
        print(f"🤖 {welcome_msg}")
...
def main():
    ...
    parser.add_argument("--tts-model", type=str, default="../tts_models/zh_CN-huayan-medium.onnx",
    ...
    if not args.disable_enhancements:
        from llm_tts_jingzhi import ConversationStyle, VocabularyStyle
        style_map = {
